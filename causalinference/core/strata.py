...
class Strata(object):
    ...
    def __init__(self, strata, subsets, pscore):
        ...
        for stratum, subset in zip(self._strata, subsets):
            ...
            stratum.summary_stats._summarize_pscore(pscore_sub_c, pscore_sub_t)
    ...
    def __str__(self):
        ...
        entries1 = ["", "Propensity Score", "Sample Size", "Ave. Propensity", "Outcome"]
        ...
        for i in range(len(strata)):
            ...
            entries3 = [i + 1, p_min, p_max, N_c, N_t, p_c_mean, p_t_mean, within]
            output += tools.add_row(entries3, entry_types3, col_spans2, table_width)
